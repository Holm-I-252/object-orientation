...
let wizard1 = new Wizard("Merlin", 150, "Fireball")
...
//Code Here
  ...
  class Phone {
    ...
    sell() {
      this.sold = `${this.brand} ${this.model} has been sold.`;
    }
...
//Code Here
  let iPhone12 = new Phone("Apple", "iPhone 12", 50, "Blue", 1200, false);
  let galaxyS21 = new Phone("Samsung", "Galaxy S21", 45, "Black", 800, false);
  let pixle5 = new Phone("Google", "Pixle 5", 35, "White", 800, false)
/* 
...
let myFirstVehicle = new Vehicle(7, "White", 150000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, "black", 25000, "Honda", true);
...
//Code Here
let myFirstBoat = new Boat(5, "white", 30000, "Yeah Buoy", "pontoon", false)
/*
